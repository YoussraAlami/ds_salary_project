...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    url = "https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=data+science&sc.keyword=data+science&locT=N&locId=115&jobType="
            ...
            while not collected_successfully:
                try:
                    company_name = driver.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div[1]/div/div[2]/section/article/div[1]/ul/li[{i}]/div[2]/div[1]/a/span').text
                    location = driver.find_element_by_xpath(
                        '//*[@id="MainCol"]/div[1]/ul/li[{i}]/div[2]/div[2]/span').text
                    job_title = driver.find_element_by_xpath(
                        '/html/body/div[3]/div/div/div[1]/div/div[2]/section/article/div[1]/ul/li[{i}]/div[2]/a/span').text
...
path = "C:/Users/Dell/Documents/ds_salary_project/chromedriver.exe"

df = get_jobs('data scientist', 3, False, path, 15)
